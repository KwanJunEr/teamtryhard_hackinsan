...
import 'collaborative_project_page2_model.dart';
export 'collaborative_project_page2_model.dart';

class CollaborativeProjectPage2Widget extends StatefulWidget {
  const CollaborativeProjectPage2Widget({super.key});

  @override
  State<CollaborativeProjectPage2Widget> createState() =>
      _CollaborativeProjectPage2WidgetState();
}

class _CollaborativeProjectPage2WidgetState
    extends State<CollaborativeProjectPage2Widget> {
  late CollaborativeProjectPage2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CollaborativeProjectPage2Model());
  }
